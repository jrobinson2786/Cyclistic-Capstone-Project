...
- l = 16 : 5751844
- l < 16 : 3850
Overwhelming majority of the rows have a lenght of 16.
This will be taken as the *correct* length of ride_id.
There are 2775 trips where ride_id length = 11 so I want
to see if there is any signifigance. 
*/
...
/*
NOTE: 
ride_id naming convention is unique and consistent under the 
specified search parameters. Nothing unusial with station names, 
station ids, lat/lng, etc. This could be significant, but propably 
not within the scope of this project. 
*/
 
--Cleaning Note: 
--disregard rows with ride_id < 16
...
/*
Final Cleaning List:
- disregard rows where ride_id length < 16
